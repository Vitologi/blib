...
class bConfig__view extends bView{
    ...
    public function build(){
        ...
        /** Buttons */
        $save    = $bPanel__view->buildButton('сохранить', array(), array(
            'action'=>'save',
            'view'   => 'index'
        ), 'bConfig__bPanel');
        ...
        /** Other interface elements */
        $blocks     = $bPanel__view->buildBlocks($this->get('blocks',array()));
        $configBlocks     = $bPanel__view->buildBlocks($this->get('confBlocks',array()));

        $location   = $bPanel__view->buildLocation('bConfig__bPanel');
        ...
        $tools      = $bPanel__view->buildTools(array($save));

        $this->setPosition('"{1}"', $blocks);
        $this->setPosition('"{2}"', $collection);
        $this->setPosition('"{3}"', $tools);
        $this->setPosition('"{4}"', $this->showConfigs());
        $this->setPosition('"{5}"', $configBlocks);
