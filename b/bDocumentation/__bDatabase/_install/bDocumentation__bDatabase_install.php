...
return array(
	'create'	=> array(
		...
		'bDocumentation'	=> array(
			'fields' => array(
				...
				'bDocumentation__group_id'	=> array('type'=> 'INT(10) UNSIGNED', 'comment'=>'menu group'),
	...
	'insert' => array(
		'bDocumentation__group' => array(
			array('id', 'name'),
			array('1', 'Публичные свойства'),
			array('2', 'Функции'),
			array('3', 'Объекты')
		),
		'bDocumentation' => array(
			array('id', 'name', 'note', 'description', 'bDocumentation__group_id', 'bDocumentation_id'),
			array('1', 'blib', '{"content":"Основной обьект фронтэнда"}', '{"content":"Расширяет среду программирования на клиентской стороне"}', 3, null),
			array('2', 'build', '{"content":"Метод для построения blib-дерева"}', '{"content":"Строит bom"}', 2, 1),
			array('3', 'Object(bom)', '{"content":"Объект возвращаемый методом построения"}', '{"content":"Объект возвращаемый методом построения"}', 3, 2)
		)
	)
);